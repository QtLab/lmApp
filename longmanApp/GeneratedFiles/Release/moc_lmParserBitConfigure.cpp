...
QT_MOC_LITERAL(1, 21, 21), // "on_toolButton_clicked"
QT_MOC_LITERAL(2, 43, 0) // ""

    },
    "lmParserBitConfigure\0on_toolButton_clicked\0"
    ""
};
...
void lmParserBitConfigure::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        lmParserBitConfigure *_t = static_cast<lmParserBitConfigure *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
void *lmParserBitConfigure::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "lmView"))
        return static_cast< lmView*>(const_cast< lmParserBitConfigure*>(this));
