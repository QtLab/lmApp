...
{
    QColor brown(190, 205, 180);//±ß½ç;
    QColor beige(180, 212, 180);
    QColor slightlyOpaqueBlack(0, 0, 0, 25);

    QPixmap backgroundImage(":/appicon/lmBackground.png");
    QPixmap buttonImage(":/appicon/lmButton.png");
	QPixmap midImage(":/appicon/woodbackground.png");// = buttonImage;
