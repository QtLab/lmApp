...
void TComYuv::getLocalPosition(TComPicYuv pic)
{
	g_auiZscanToRaster = pic.g_auiZscanToRaster;
	g_auiRasterToZscan = pic.g_auiRasterToZscan;
	g_auiRasterToPelX = pic.g_auiRasterToPelX;
	g_auiRasterToPelY = pic.g_auiRasterToPelY;
}
